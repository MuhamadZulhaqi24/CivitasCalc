...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previousCalculation = findViewById(R.id.previewCalculationView);
    ...
    public void equalBTNPush(View view){
        ...
        previousCalculation.setText(userExp); //fitur history di tampilan atas

        userExp = userExp.replaceAll
                (getResources().getString(R.string.divideText),
                        "/"); //setelah dihasilkan dengan bagi harus bagi
        userExp = userExp.replaceAll
                (getResources().getString(R.string.multiplyText),
                        "*"); //setelah dihasilkan kali harus kali
